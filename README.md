...
## Explication remoteEntry.js

C’est le fichier que le shell télécharge (ici depuis http://localhost:3001/remoteEntry.js) pour découvrir quels modules le MFE publie et comment les charger à la demande.
